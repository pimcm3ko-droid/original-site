...
<section class="mainvisual">
        ...
        <section class="concept" id="concept">
            ...
            <div class="wrapper fadein">
                <p>“心やすらぐ、ひとときを”</p>
                <p>HYGGE CAFE（ヒュッゲカフェ）は、北欧のライフスタイルHyggeからインスピレーションを得たカフェです。</p>
                <p>「Hygge（ヒュッゲ）」とは、デンマーク語で「居心地の良い雰囲気」や「心地よい時間」を意味する言葉。</p>
                <p>忙しさに追われる毎日に、「ほっと一息つける場所を提供したい」「日常のスピードを少しだけ緩める場所を作りたい」という想いからこのカフェを始めました。</p>
                <p>シンプルで美しいインテリア、厳選されたオーガニック素材、そして温かな光に包まれた空間で、あなたの大切な時間をお過ごしください。</p>
            </div>
            <div class="bg"></div>
        </section>
        ...
        <section class="toppage_menu" id="">
            ...
            <div class="wrapper fadein">
                ...
                <div class="text">
                    <p>コーヒーは当店のオリジナルブレンドをハンドドリップで一杯一杯丁寧に抽出しています。</p>
                    <p>当店で仕込んだサンドイッチやスイーツも各種ご用意しています。</p>
